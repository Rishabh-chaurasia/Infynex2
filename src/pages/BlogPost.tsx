        ...
        <div className="container-x grid gap-12 py-20 lg:grid-cols-[1fr_2fr_1fr]">
          ...
          <div className="prose-infynex">
            ...
            {post.body.map((para, i) => (
              <motion.p key={i} variants={fadeUp} custom={1} initial="hidden" whileInView="visible" viewport={viewportOnce} className="mt-6 text-lg leading-relaxed text-ink-600">{para}</motion.p>
            ))}
