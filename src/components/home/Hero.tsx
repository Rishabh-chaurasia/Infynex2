  ...
  return (
    <section className="source-hero relative isolate flex min-h-[620px] items-center overflow-hidden bg-[#041521] text-white sm:min-h-[680px] lg:min-h-[700px]">
      ...
      <div className="source-hero-content container-x relative z-10 pb-7 pt-28 md:pt-32">
        ...
        <motion.p initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .8, delay: .3, ease: EASE }} className="mt-4 max-w-[690px] text-[.88rem] leading-[1.65] text-white/75 sm:mt-6 sm:text-[.95rem] sm:leading-[1.75] md:max-w-[55%]">From robust IT infrastructure, AMC support and cloud servers to advanced robotic duct cleaning and integrated operational services, Infynex Technologies delivers reliable solutions that enhance efficiency, strengthen security and keep your business running seamlessly.</motion.p>
