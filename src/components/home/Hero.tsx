...
export default function Hero() {
  return (
    <section className="source-hero relative isolate flex min-h-[680px] items-center sm:min-h-[720px] overflow-hidden bg-[#041521] text-white lg:min-h-[700px]">
      ...
      <div className="source-hero-content container-x relative z-10 pb-7 pt-28 md:pt-32">
        ...
        <motion.h1 initial={{ opacity: 0, y: 35 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .9, delay: .15, ease: EASE }} className="max-w-[930px] font-display text-[clamp(2.3rem,10.5vw,4.7rem)] font-medium leading-[1.07] tracking-[-.035em] md:max-w-[55%] md:text-[clamp(3rem,5.2vw,4.7rem)] lg:max-w-[58%]">Powering Your Business<br /><span className="source-hero-accent">with Services That Work.</span></motion.h1>
