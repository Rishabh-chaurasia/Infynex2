...
export default function EditorialTechnology() {
    return (<section className="relative min-h-[760px] overflow-hidden bg-[linear-gradient(110deg,#f8fbfd_0%,#e4f7fb_48%,#fbfcfd_100%)] py-20 md:py-24">
