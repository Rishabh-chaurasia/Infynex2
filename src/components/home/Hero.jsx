...
export default function Hero() {
    return (<section className="source-hero relative isolate flex min-h-[620px] items-center overflow-hidden bg-[#041521] text-white sm:min-h-[680px] lg:min-h-[700px]">
      ...
      <div className="source-hero-content container-x relative z-10 pb-7 pt-28 md:pt-32">
        ...
        <motion.h1 initial={{ opacity: 0, y: 35 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .9, delay: .15, ease: EASE }} className="max-w-[72ch] font-display text-[length:var(--step-4)] font-medium leading-[1.07] tracking-[-.035em] md:max-w-[62%]">Powering Your Business<br /><span className="source-hero-accent">With Reliable Solutions That Deliver Results.</span></motion.h1>
