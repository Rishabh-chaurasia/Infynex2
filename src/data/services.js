import { Wrench, Cpu, Server, Cloud, PhoneCall, Bot, Headset, Car, Sun, } from 'lucide-react';
...
export const services = [
    {
        ...
        overview: 'Our AMC service combines scheduled preventive maintenance, fault diagnosis, repairs and service documentation under one accountable contract. This structured approach supports equipment reliability, operational continuity and clearer maintenance planning.',
        icon: Wrench,
        accent: '#1a9dc3',
        hero: images.amcHero,
    ...
    },
    {
        ...
        overview: 'We specify, procure, deploy and maintain hardware aligned with your users, workloads and operating environment. Our coverage includes computers, servers, network devices, peripherals and supporting office technology.',
        icon: Cpu,
        accent: '#2ab7dd',
        hero: images.hwHero,
    ...
    },
    {
        ...
        overview: 'We design and deploy secure, resilient networks, servers and storage for new and existing workplaces. Every environment is fully documented and supported for dependable day-to-day management and future growth.',
        icon: Server,
        accent: '#6fd3ee',
    ...
    },
    {
        ...
        overview: 'We provision secure cloud environments, migrate applications and data, configure controlled access and manage ongoing operations. The result is a scalable platform supported by structured administration, monitoring and recovery practices.',
        icon: Cloud,
        accent: '#1a9dc3',
    ...
    },
    {
        ...
        overview: 'Our trained teams manage inbound calls, outbound campaigns and customer follow-ups through approved scripts, escalation paths and quality controls. Clear reporting provides visibility across call activity, outcomes and customer feedback.',
        icon: PhoneCall,
        accent: '#2ab7dd',
    ...
    },
    {
        ...
        overview: 'Camera-equipped robotic systems inspect and clean internal HVAC ductwork with controlled precision. Before-and-after footage, visual verification and structured service documentation provide a clear record of completed work.',
        icon: Bot,
        accent: '#6fd3ee',
    ...
    },
    {
        ...
        overview: 'Our helpdesk records, prioritises and resolves user requests through approved support channels. Remote resolution is supported by coordinated on-site engineering whenever physical intervention, repair or installation is required.',
        icon: Headset,
        accent: '#1a9dc3',
        hero: images.tsHero,
    ...
    },
    {
        ...
        overview: 'Our business vehicle service coordinates fleet planning, vehicle selection, procurement, registration and delivery under a clearly defined commercial agreement. A dedicated account team manages documentation, billing and ongoing coordination for both focused and large-scale fleet requirements.',
        icon: Car,
        accent: '#6fd3ee',
        hero: images.vvHero,
    ...
    },
    {
        ...
        overview: 'Our solar service covers site assessment, system design, equipment selection, installation, commissioning and scheduled maintenance. Every solution is aligned with site conditions, energy requirements, electrical safety and long-term operating performance.',
        icon: Sun,
        accent: '#f5b544',
