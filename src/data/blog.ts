...
export interface BlogPost {
  ...
  category: string
  excerpt: string
  date: string // ISO; EDIT with real publish dates
  readTime: string
  image: string
...
export const posts: BlogPost[] = [
  {
    ...
    title: 'Why preventive maintenance beats break-fix for office IT',
    category: 'AMC',
    excerpt: 'Waiting for equipment to fail is the most expensive way to run an office. Here is how a planned maintenance calendar changes the picture.',
    date: '2026-08-18',
    readTime: '4 min read',
    image: images.blog6,
    body: [
  ...
  },
  {
    ...
    title: 'What is really inside your HVAC ducts — and how robots clean it',
    category: 'Robotic Duct Cleaning',
    excerpt: 'Ductwork is out of sight, which is exactly why it collects dust, debris and contaminants. Camera-guided robots make the interior visible and cleanable.',
    date: '2026-07-30',
    readTime: '5 min read',
    image: images.blog3,
    body: [
  ...
  },
  {
    ...
    title: 'Planning a rooftop solar system: what a site survey looks at',
    category: 'Solar',
    excerpt: 'Before any panel is mounted, a good solar installer studies the roof, the shading and the electrical load. Here is what that survey covers.',
    date: '2026-07-12',
    readTime: '4 min read',
    image: images.blog2,
    body: [
  ...
  },
  {
    ...
    title: 'Helpdesk or on-site engineer? Choosing the right support model',
    category: 'Support',
    excerpt: 'Remote helpdesks resolve many issues quickly, but some problems need hands on hardware. Most organisations end up needing both.',
    date: '2026-06-25',
    readTime: '3 min read',
    image: images.blog4,
    body: [
  ...
  },
  {
    ...
    title: 'A practical checklist before moving workloads to cloud servers',
    category: 'Cloud',
    excerpt: 'Migration goes smoothly when dependencies, data and access are mapped out first. Use this checklist to prepare.',
    date: '2026-06-05',
    readTime: '5 min read',
    image: images.blog5,
    body: [
  ...
  },
  {
    ...
    title: 'Choosing hardware for a new office: start with the work, not the spec sheet',
    category: 'Hardware',
    excerpt: 'The right equipment depends on what people actually do all day. A short requirement exercise avoids over- and under-buying.',
    date: '2026-05-20',
    readTime: '4 min read',
    image: images.blog1,
    body: [
